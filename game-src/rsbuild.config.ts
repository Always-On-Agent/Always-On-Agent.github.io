        ...
        pluginTypedCSSModules(),
        {
            ...
            setup(build: RsbuildPluginAPI) {
                const prep = async () => {
                    ...
                    if (fs.existsSync('./assets/maps/ntu')) fsExtra.copySync('./assets/maps/ntu', './dist/maps/ntu-campus-v2')
                    if (fs.existsSync('./game-assets/maps/ntu-campus-v3')) fsExtra.copySync('./game-assets/maps/ntu-campus-v3', './dist/maps/ntu-campus-v3')
