...
import { selectWorks, selectCases, worksCSV } from "../research-core.mjs";
...
test("application filters preserve multi-domain, multi-participant, and unmeasured cases", () => {
  assert.equal(data.applications.length, 36);
  assert.equal(data.applications.find(item => item.id === "assistantx").domains.length, 2);
